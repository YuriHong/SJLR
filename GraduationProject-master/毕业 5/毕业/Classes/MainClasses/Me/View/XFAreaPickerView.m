...
- (void)clickOK
{
    ...
    if (self.delegate != nil && [self.delegate respondsToSelector:@selector(areaPickerView:didSelectProvince:selectedCity:selectedDistrict:)])
    {
        [self.delegate areaPickerView:self didSelectProvince:self.selectedProvince selectedCity:self.selectedCity selectedDistrict:self.selectedDistrict];
    }
}
