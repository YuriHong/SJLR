...
class HistogramSpecification: CIFilter, VImageFilter
{
    ...
    override var outputImage: CIImage?
    {
        ...
        var alpha = [UInt].init(repeating: 0, count: 256)
        var red = [UInt].init(repeating: 0, count: 256)
        var green = [UInt].init(repeating: 0, count: 256)
        var blue = [UInt].init(repeating: 0, count: 256)
        ...
        var rgba = [redMutablePointer, greenMutablePointer, blueMutablePointer, alphaMutablePointer]
        ...
        var RGBA = [redPointer, greenPointer, bluePointer, alphaPointer]
        let rgbaMutablePointer = UnsafeMutablePointer<UnsafePointer<vImagePixelCount>?>(&RGBA)
