...
{
    FFSearchView *view = [[FFSearchView alloc] initWithFrame:CGRectMake(15, 0, SCREEN_WIDTH - 30, 30)];
    view.done = done;
    view.backgroundColor = RGBCOLOR(196, 108, 96);
    view.layer.masksToBounds = YES;
    view.layer.cornerRadius = 15;
    UITextField *textField = [[UITextField alloc] initWithFrame:CGRectMake(29, 0, view.width - 29, view.height)];
    ...
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(12, 7, 15, 15)];
